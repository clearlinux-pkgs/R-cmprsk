...
Version  : 2.2.12
Release  : 50
URL      : https://cran.r-project.org/src/contrib/cmprsk_2.2-12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/cmprsk_2.2-12.tar.gz
Summary  : Subdistribution Analysis of Competing Risks
Group    : Development/Tools
License  : GPL-2.0 GPL-2.0+
Requires: R-cmprsk-lib = %{version}-%{release}
Requires: R-cmprsk-license = %{version}-%{release}
...
%package license
Summary: license components for the R-cmprsk package.
Group: Default

%description license
license components for the R-cmprsk package.


%prep
%setup -q -n cmprsk
pushd ..
cp -a cmprsk buildavx2
popd
pushd ..
cp -a cmprsk buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716146789

%install
export SOURCE_DATE_EPOCH=1716146789
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-cmprsk
cp %{_builddir}/cmprsk/COPYING %{buildroot}/usr/share/package-licenses/R-cmprsk/dfac199a7539a404407098a2541b9482279f690d || :
LANG=C.UTF-8
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/cmprsk/libs/cmprsk.so
/V4/usr/lib64/R/library/cmprsk/libs/cmprsk.so
/usr/lib64/R/library/cmprsk/libs/cmprsk.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-cmprsk/dfac199a7539a404407098a2541b9482279f690d
